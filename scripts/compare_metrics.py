...
SELECTED_METRICS = [
    ...
    ("Phasing", "Switch error rate (input sites)", "switch_error_rate_input_sites"),
    ("Phasing", "Phase concordance", "phase_concordance"),
    ("Phasing", "N50 phase block", "n50_phase_block"),
    ("Phasing", "Phase block count", "phase_block_count"),
    ("Phasing", "Phase block length mean (bp)", "phase_block_len_mean"),
    ("Phasing", "Phase block length median (bp)", "phase_block_len_median"),
    ("Phasing", "Phase block length p90 (bp)", "phase_block_len_p90"),
