...
impl ModelParams {
    ...
    pub fn for_phasing(n_haps: usize, ne: f32, err: Option<f32>) -> Self {
        ...
        // Scaled by 1e-6 to align with cM units (1 cM = 1 Mb)
        let recomb_intensity = 0.04 * ne * 1e-6 / n_haps as f32;
    ...
    pub fn for_imputation(
        ...
        // Scaled by 1e-6 to align with cM units (1 cM = 1 Mb)
        let recomb_intensity = 0.04 * ne * 1e-6 / n_ref_haps as f32;
...
mod tests {
    ...
    fn test_recomb_intensity_formula() {
        ...
        // Should be 0.04 * 1_000_000 * 1e-6 / 1000 = 0.04
        let expected = 0.04 * 1_000_000.0 * 1e-6 / 1000.0;
