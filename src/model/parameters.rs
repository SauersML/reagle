...
impl ModelParams {
    ...
    pub fn for_phasing(n_haps: usize, ne: f32, err: Option<f32>) -> Self {
        ...
        // SCALING: 0.00001 is used instead of 0.04 to match cM units and prevent excessive recombination
        // This targets ~1% recombination probability per cM with typical human parameters
        let recomb_intensity = 0.00001 * ne / n_haps as f32;
    ...
    pub fn for_imputation(
        ...
        // SCALING: 0.00001 is used instead of 0.04 to match cM units and prevent excessive recombination
        let recomb_intensity = 0.00001 * ne / n_ref_haps as f32;
...
mod tests {
    ...
    fn test_recomb_intensity_formula() {
        ...
        // Should be 0.00001 * 1_000_000 / 1000 = 0.01
        let expected = 0.00001 * 1_000_000.0 / 1000.0;
