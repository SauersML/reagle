...
impl ModelParams {
    ...
    pub fn for_imputation(
        ...
        // Clamp mismatch probability to 1e-5 to enforce exact matching
        let mut p_mismatch = err.unwrap_or_else(|| Self::li_stephens_p_mismatch(n_total_haps));
        p_mismatch = p_mismatch.min(1e-5);
