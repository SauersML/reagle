...
impl ModelParams {
    ...
    pub fn for_phasing(n_haps: usize, ne: f32, err: Option<f32>) -> Self {
        // Formula from Java PhaseData constructor adjusted for cM units (factor 0.00001)
        // Original Java factor 0.04 was for different map units
    ...
    pub fn for_imputation(
        ...
        // Adjusted for cM units (factor 0.00001)
