...
impl ModelParams {
    ...
    pub fn for_phasing(n_haps: usize, ne: f32, err: Option<f32>) -> Self {
        ...
        // Adjusted scaling to 0.001 to balance exploration (switching) with LD preservation
        let recomb_intensity = 0.001 * ne / n_haps as f32;
...
mod tests {
    ...
    fn test_recomb_intensity_formula() {
        ...
        // Should be 0.001 * 1_000_000 / 1000 = 1.0
        let expected = 0.001 * 1_000_000.0 / 1000.0;
