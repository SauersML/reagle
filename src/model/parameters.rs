...
impl ModelParams {
    ...
    /// Minimum mismatch probability (prevents locking into wrong state in perfect LD)
    ...
    pub fn for_imputation(
        ...
        // For imputation, we default to the minimum mismatch probability to encourage
        // switching to rare haplotypes in high LD regions (Perfect LD Trap), rather
        // than using the Li-Stephens approximation which might be too high.
