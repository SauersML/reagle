...
impl ModelParams {
    ...
    /// Max recombination intensity (switches per cM) to prevent excessive switching in small panels
    pub const MAX_RECOMB_INTENSITY: f32 = 5.0;

    /// Minimum phase confidence for imputation input to prevent Prior Dominance
