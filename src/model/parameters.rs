...
impl ModelParams {
    ...
    /// Default mismatch probability floor to prevent "Perfect LD Trap"
    ///
    /// If p_mismatch is too small (e.g. < 1e-4), the HMM becomes overconfident
    /// in reference haplotypes and refuses to impute rare variants or recombination
    /// events that aren't perfectly supported by the reference.
