...
impl ModelParams {
    ...
    pub fn for_phasing(n_haps: usize, ne: f32, err: Option<f32>) -> Self {
        ...
        let recomb_intensity = 1e-5 * ne / n_haps as f32;
    ...
    pub fn for_imputation(
        ...
        let recomb_intensity = 1e-5 * ne / n_ref_haps as f32;
...
mod tests {
    ...
    fn test_recomb_intensity_formula() {
        ...
        // Should be 1e-5 * 1_000_000 / 1000 = 0.01
        let expected = 1e-5 * 1_000_000.0 / 1000.0;
