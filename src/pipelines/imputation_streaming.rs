...
impl crate::pipelines::ImputationPipeline {
    ...
    >(
        ...
        // Producer and consumer run in separate phases in this function: HMM work
        // emits all sample results before receive-side orientation smoothing starts.
        // Use a non-blocking channel to avoid producer-side deadlock.
